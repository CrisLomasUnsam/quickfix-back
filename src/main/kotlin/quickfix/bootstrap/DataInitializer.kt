...
class DataInitializer : InitializingBean {
    ...
    fun loadJobRequestsToRedis() {
        ...
        val jobRequest7 = JobRequestBuilder.buildMock(users["Tomas"]!!, professions["Pinturería"]!!)
    ...
    fun loadJobOffersToRedis() {
        ...
        val jobOffer7 = JobOfferBuilder.buildMock(users["Tomas"]!!, users["Mariano"]!!, professions["Pinturería"]!!, 7)
