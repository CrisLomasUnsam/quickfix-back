    ...
    fun securityFilterChain(httpSecurity: HttpSecurity): SecurityFilterChain {
        return httpSecurity
            ...
            .authorizeHttpRequests {
                ...
                it.requestMatchers(HttpMethod.GET, "/job/myJobRequests").hasAuthority(Role.CUSTOMER.name)
                ...
                it.requestMatchers(HttpMethod.GET, "/job/jobRequestId/**").hasAuthority(Role.CUSTOMER.name)
                ...
                it.requestMatchers(HttpMethod.GET, "/job/myJobOffers").hasAuthority(Role.PROFESSIONAL.name)
                it.requestMatchers(HttpMethod.POST, "/job/offerJob").hasAuthority(Role.PROFESSIONAL.name)
