...
class JobController(
    ...
    fun getJobDetailsByJobId(@ModelAttribute("currentUserId") currentCustomerId: Long, @PathVariable jobId: Long): JobDetails =
        jobService.getJobDetailsById(currentCustomerId, jobId)
