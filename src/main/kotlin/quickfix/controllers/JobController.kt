...
class JobController(
    ...
    fun requestJob(@ModelAttribute("currentUserId") currentProfessionalId : Long, @RequestBody jobRequest : CreateJobRequestDTO) =
        jobService.requestJob(currentProfessionalId, jobRequest)
