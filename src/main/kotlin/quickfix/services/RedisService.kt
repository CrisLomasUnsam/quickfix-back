...
class RedisService(
    ...
    fun requestJob(jobRequest : JobRequestDTO) {
        ...
        val isFutureRequest = durationUntilRequestIsNeeded.toMinutes() > MINUTES_TO_BE_CONSIDERED_FUTURE_REQUEST
    ...
    fun getJobRequests(professionIds : Set<Long>) : List<JobRequestDTO> {
